                            ...
                            <div class="row">
                                <div class="col-4">
                                    <div class="wrap-user-picture-circle">
                                        <img class="primary-user-picture-circle" src="<?= $checkdata_user_details['url_photo_profile']?>" />
                                    </div>
                                </div>
                            </div>
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <input name="user_balance" value="<?php echo $checkdata_user_details['user_balance']; ?>" type="number"
                                                        class="form-control input-type-primary-tiketsaya"
